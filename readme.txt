...
Contributors:sony7596, miraclewebssoft, reachbaljit, germanramos
...
* Use title of the post for notification Title
* Use category of the post as topic to send the message with firebase
* Use topic "test" as test notification
